...
<body>
	...
	<div id="index_layout">
		<div data-options="region:'north'" style=" overflow: hidden;" id="header">
			<span style="float: right; padding-right: 20px;">欢迎 <b><font color="red">${sessionInfo.name}</font></b>&nbsp;&nbsp; <a href="javascript:void(0)" onclick="editUserPwd()" style="color: #fff">修改密码</a>&nbsp;&nbsp;<a href="javascript:void(0)" onclick="logout()" style="color: #fff">安全退出</a>
        	&nbsp;&nbsp;&nbsp;&nbsp;
    		</span>
		...
		<div data-options="region:'south',border:false" style="height: 30px; overflow: hidden;text-align: center;background-color: #daeef5" >developer:儛殇   技术qq:309912718 </div>
	</div>
